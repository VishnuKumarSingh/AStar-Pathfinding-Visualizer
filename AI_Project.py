...
pygame.display.set_caption("A* Shortest Path Finder")
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    if not start or not end:
                        # Invalid form case (missing start/end)
                        font = pygame.font.SysFont("Arial", 50, bold=True)
                        text = font.render("Path Not Found or Invalid Form", True, RED)
                        ...
                        if not found:
                            font = pygame.font.SysFont("Arial", 50, bold=True)
                            text = font.render("Path Not Found or Invalid path", True, RED)
                            win.blit(text, (WIDTH//2 - text.get_width()//2, WIDTH//2 - text.get_height()//2))
                            pygame.display.update()
                            pygame.time.wait(2000)
